...
func UnBlackUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UnBlackUserReq
		...
		l := imuser.NewUnBlackUserLogic(r.Context(), svcCtx)
		resp, err := l.UnBlackUser(&req)
		if err != nil {
			xhttp.ParamErrorResult(r, w, err)
			//httpx.Error(w, err)
		} else {
