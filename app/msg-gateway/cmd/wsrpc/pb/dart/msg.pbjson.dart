...
const MsgData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'serverTime', '3': 14, '4': 1, '5': 3, '10': 'serverTime'},
    const {'1': 'clientTime', '3': 15, '4': 1, '5': 3, '10': 'clientTime'},
    const {'1': 'offlinePushInfo', '3': 16, '4': 1, '5': 11, '6': '.pb.OfflinePushInfo', '10': 'offlinePushInfo'},
    const {'1': 'atUserIDList', '3': 17, '4': 3, '5': 9, '10': 'atUserIDList'},
    const {'1': 'options', '3': 18, '4': 3, '5': 11, '6': '.pb.MsgData.OptionsEntry', '10': 'options'},
  ],
...
final $typed_data.Uint8List msgDataDescriptor = $convert.base64Decode('');
...
const SendMsgResp$json = const {
  '1': 'SendMsgResp',
  '2': const [
    const {'1': 'serverMsgID', '3': 1, '4': 1, '5': 9, '10': 'serverMsgID'},
    const {'1': 'clientMsgID', '3': 2, '4': 1, '5': 9, '10': 'clientMsgID'},
    const {'1': 'serverTime', '3': 3, '4': 1, '5': 3, '10': 'serverTime'},
  ],
};

/// Descriptor for `SendMsgResp`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sendMsgRespDescriptor = $convert.base64Decode('CgtTZW5kTXNnUmVzcBIgCgtzZXJ2ZXJNc2dJRBgBIAEoCVILc2VydmVyTXNnSUQSIAoLY2xpZW50TXNnSUQYAiABKAlSC2NsaWVudE1zZ0lEEh4KCnNlcnZlclRpbWUYAyABKANSCnNlcnZlclRpbWU=');
