...
class PullMessageBySuperGroupSeqListReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PullMessageBySuperGroupSeqListReq', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupID', protoName: 'groupID')
    ..p<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seqList', $pb.PbFieldType.PU3, protoName: 'seqList')
    ..hasRequiredFields = false
  ;

  PullMessageBySuperGroupSeqListReq._() : super();
  factory PullMessageBySuperGroupSeqListReq({
    $core.String? groupID,
    $core.Iterable<$core.int>? seqList,
  }) {
    final _result = create();
  ...
  factory PullMessageBySuperGroupSeqListReq.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PullMessageBySuperGroupSeqListReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PullMessageBySuperGroupSeqListReq clone() => PullMessageBySuperGroupSeqListReq()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PullMessageBySuperGroupSeqListReq copyWith(void Function(PullMessageBySuperGroupSeqListReq) updates) => super.copyWith((message) => updates(message as PullMessageBySuperGroupSeqListReq)) as PullMessageBySuperGroupSeqListReq; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PullMessageBySuperGroupSeqListReq create() => PullMessageBySuperGroupSeqListReq._();
  PullMessageBySuperGroupSeqListReq createEmptyInstance() => create();
  static $pb.PbList<PullMessageBySuperGroupSeqListReq> createRepeated() => $pb.PbList<PullMessageBySuperGroupSeqListReq>();
  @$core.pragma('dart2js:noInline')
  static PullMessageBySuperGroupSeqListReq getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PullMessageBySuperGroupSeqListReq>(create);
  static PullMessageBySuperGroupSeqListReq? _defaultInstance;
...
class PullMessageBySeqListResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PullMessageBySeqListResp', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..pc<MsgData>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'list', $pb.PbFieldType.PM, subBuilder: MsgData.create)
    ..hasRequiredFields = false
  ;
